...
function solution(n, k) {
    ...
    //이때 0을 포함한 수가 소수가 되는 케이스 (예를들어 21101111)같은 경우에 2110은 0을 사용 했기때문에 이후에는 사용한 0을 제외하고 1111가지고만 판별해야한다.
    //따라서 0을 기준으로 분리하면 나머지 숫자에 0을 포함또는 0을제외한 소수라고 볼수있다.
    // 21101111 -> 211, 1111로 분리되는데 이는 (2110,1111),(211,01111)로 보아도 무관하다는 소리가 된다. 0은 한번밖에 사용하지 않기 떄문이다.
